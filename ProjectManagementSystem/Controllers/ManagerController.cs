    ...
    ITimesheetService timesheetService) : ControllerBase
{
    ...
    public async Task<IActionResult> GetEmployeeDetail(int id)
    {
        ...
        if (detail is null)
            return NotFound(ApiResponse<object>.Fail(ErrorMessages.EmployeeNotFound));
    ...
    public async Task<IActionResult> GetProjectDetail(int id)
    {
        ...
        if (detail is null)
            return NotFound(ApiResponse<object>.Fail(ErrorMessages.ProjectNotFound));
    ...
    public async Task<IActionResult> CreateAllocation([FromBody] CreateAllocationDto dto)
    {
        ...
        return Ok(ApiResponse<AllocationDto>.Ok(result, SuccessMessages.AllocationCreated));
    }
    ...
    public async Task<IActionResult> EndAllocation(int id, [FromBody] EndAllocationDto dto)
    {
        ...
        if (allocation is null)
            return NotFound(ApiResponse<object>.Fail(ErrorMessages.AllocationNotFound));
        ...
        return Ok(ApiResponse<object>.Ok(null!, SuccessMessages.AllocationEnded));
    }

...
{
    /// <inheritdoc />
    public partial class InitialResourcesSchema : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LlmApiKey = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    SchedulerIntervalHours = table.Column<int>(type: "int", nullable: false, defaultValue: 4),
                    MaxWeeklyHours = table.Column<int>(type: "int", nullable: false, defaultValue: 40)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsForcePasswordChange = table.Column<bool>(type: "bit", nullable: false, defaultValue: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdatedAt = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Resources_Users_ReportingManagerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProjectId = table.Column<int>(type: "int", nullable: false),
                    UtilisationPercent = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Timesheets_Resources_ResourceId",
                        column: x => x.ResourceId,
                        principalTable: "Resources",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ActivityTags = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Resources_ReportingManagerId",
                table: "Resources",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ResourceSkills_ResourceId_SkillId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Timesheets_ResourceId_WeekStartDate",
                table: "Timesheets",
